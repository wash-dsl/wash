...
Definition (``src/wash_serial.hpp``)
------------------------------------
...
.. toctree::
   ...
   program_listing_file_src_wash_serial.hpp.rst
...
- ``wash_mockapi.hpp`` (:ref:`file_src_wash_mockapi.hpp`)
