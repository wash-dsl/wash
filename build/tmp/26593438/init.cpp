...
void init_driver(wash::Particle *particles, int numParticles){
    // Call init global with all of the device vectors from globals and all of the constants
}

// Must be generated by dsl
__global__ void init_global(wash::Particle *particles, int numParticles, double variable_num_part_1d, double *scalar_force_id, double *scalar_force_mass, double* scalar_force_smoothing_length, double *scalar_force_temp,
